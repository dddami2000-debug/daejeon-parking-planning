...
`대전콕`은 차를 타고 대전의 축제·랜드마크를 방문하려는 사용자를 위한 서비스입니다. 목적지가 없는 사용자는 세 가지 방문 조건으로 갈 곳을 고르고, 목적지가 정해진 사용자는 바로 검색한 뒤 실제 방문 시간에 운영하는 주차장까지 이어서 비교할 수 있습니다.
...
- 축제·랜드마크 선택 시 일정, 현재 상태, 핵심 프로그램, 입장·예약, 우천·취소, 공식 출처와 업데이트 시각 제공
